...
- [Codex developer commands](https://learn.chatgpt.com/docs/developer-commands?surface=cli): CLI option contracts. Local CLI 0.153.4 behavior remains the acceptance target.
