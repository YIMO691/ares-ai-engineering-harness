...
| 文档与 Ready | 维护功能入口及相关记录，生成本轮 L1/L2/L3 快照，冻结六项意图和真实授权 | Issue 记录 Task ID、文档版本或安全引用、验收项及授权来源 |
...
小型文档更正可直接用 PR 留痕。L1/L2/L3 控制现有 Harness 快照格式，FAST/STANDARD/CRITICAL 控制检查强度，两者不自动对应。PR 链接项目功能入口和受影响的实现/验证记录，已有文档继续维护，不复制一套 PRD/SDD/DELIVERY。
